...
class DBConnectionsTest extends AbstractContainerDatabaseTest {
  ...
  private void assertHasCorrectExposedAndLivenessCheckPorts(
      final MSSQLServerContainer<?> mssqlServer) {
    assertThat(mssqlServer.getExposedPorts())
        .containsExactly(MSSQLServerContainer.MS_SQL_SERVER_PORT);
